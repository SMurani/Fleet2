...
public class DispatchAction extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		dispatch.setVehicle_id(Long.parseLong(request.getParameter("dipatchVehicle")));


		dispatch.setClient_id(Long.parseLong(request.getParameter("dispatchClient")));
	...
	private void list(HttpServletResponse response)
		...
		for(Dispatch dispatch : dispatchs){
			...
			resp.println("<tr>");
			resp.print("<td>" + (dispatch.getVehicle_id()) + "</td>");
			resp.print("<td>" + (dispatch.getClient_id()) + "</td>");
